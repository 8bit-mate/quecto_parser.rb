...
module CharRules
  ...
  CONST_FIRST_CHAR = /[[:alpha:]]/.freeze # characters that could be used as a 1st char. in a constant's name
  CONST_CHAR = /[[:alpha:][:digit:]_]/.freeze # characters that could form a constant: letters, digits, underscore char.
